...
class RTCEngine extends events.EventEmitter
{
        ...
        peerconnection.ontrack = (event) => {
            ...
            setTimeout(() => {
                ...
                if (rtcstream._hasMedia) {
                    logger.error("already have media");
                    return;
                }
    ...
    async _subscribe(streamId, stream) 
    {
        ...
        stream._peerconnection.addTransceiver("audio",{direction:"inactive"});
        stream._peerconnection.addTransceiver("video",{direction:"inactive"});
